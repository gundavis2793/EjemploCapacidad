...
namespace App_Utb
{
    ...
    public partial class MostrarCarreraSanta 
    {
        private CarreraSanta carrera { get; set; }
        public MostrarCarreraSanta()
        {
            InitializeComponent();
        }
        ...
        public MostrarCarreraSanta(int a)
        {
            InitializeComponent();
            var carr = new CarreraViewModelsSanta();
